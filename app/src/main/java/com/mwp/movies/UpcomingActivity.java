...
public class UpcomingActivity extends Activity {
	...
	private void setTopRatedList() {
		...
		try {
			...
			dialog = ProgressDialog.show(UpcomingActivity.this, "",
			...
			new Thread(new Runnable() {
				...
				public void run() {
					// TODO Auto-generated method stub
					JSONData h = new JSONData(UpcomingActivity.this);
					try {
						if (Utlity.isOnline(UpcomingActivity.this)) {
							...
							if (topRatedList == null) {
								...
								mHandler.post(new Runnable() {
									@Override
									public void run() {
										Toast.makeText(UpcomingActivity.this,	"No Data Found",Toast.LENGTH_LONG).show();
										if (dialog != null && dialog.isShowing())
											dialog.dismiss();
										loadingMore = false;
										mainListAdapter = new NewRelAdapter(UpcomingActivity.this,topRatedList);
										int fvcount = mainList.getFooterViewsCount();
										for (int f = 0; f < fvcount; f++) {
											mainList.removeFooterView(footer);
										}
										...
										mainList.setOnItemClickListener(new OnItemClickListener() {
											...
											public void onItemClick(AdapterView<?> parent, View view, int position,
												...
												if (position < topRatedList.size()) {
													Intent i = new Intent(UpcomingActivity.this, SecondActivity.class);
							...
							runOnUiThread(new Runnable() {
								@Override
								public void run() {
									Toast.makeText(UpcomingActivity.this,	"No Network Detected",Toast.LENGTH_LONG).show();
								}
							});
						}
	...
	Runnable getDataOnListEnd = new Runnable() {
		...
		public void run() {
			// TODO Auto-generated method stub
			loadingMore = true;
			JSONData data = new JSONData(UpcomingActivity.this);
			try {
				
					final List<TopRatedDAta> alist = data.getAlbumList(pageNo,"upcoming");
				...
				public void run() {
					// TODO Auto-generated method stub
					Toast.makeText(UpcomingActivity.this,
