...
public class TopRatedActivity extends Activity {
	...
	private void setTopRatedList() {
		...
		try {
			...
			dialog = ProgressDialog.show(TopRatedActivity.this, "",
			...
			new Thread(new Runnable() {
				...
				public void run() {
					// TODO Auto-generated method stub
					JSONData h = new JSONData(TopRatedActivity.this);
					try {
						if (Utlity.isOnline(TopRatedActivity.this)) {
							...
							if (topRatedList == null) {
								...
								mHandler.post(new Runnable() {
									@Override
									public void run() {
										Toast.makeText(TopRatedActivity.this,	"No Data Found",Toast.LENGTH_LONG).show();
										if (dialog != null && dialog.isShowing())
											dialog.dismiss();
										loadingMore = false;
										mainListAdapter = new NewRelAdapter(TopRatedActivity.this,topRatedList);
										int fvcount = mainList.getFooterViewsCount();
										for (int f = 0; f < fvcount; f++) {
											mainList.removeFooterView(footer);
										}
									...
									public void run() {
										...
										mainList.setOnItemClickListener(new OnItemClickListener() {
											...
											public void onItemClick(AdapterView<?> parent, View view, int position,
												...
												{
													Intent i = new Intent(TopRatedActivity.this,SecondActivity.class);
							...
							runOnUiThread(new Runnable() {
								@Override
								public void run() {
									Toast.makeText(TopRatedActivity.this,	"No Network Detected",Toast.LENGTH_LONG).show();
								}
							});
						}
	...
	Runnable getDataOnListEnd = new Runnable() {
		...
		public void run() {
			// TODO Auto-generated method stub
			loadingMore = true;
			JSONData data = new JSONData(TopRatedActivity.this);
			try {
				
					final List<TopRatedDAta> alist = data.getAlbumList(pageNo,"top_rated");
