...
public class PopularMovies extends Activity {
    ...
    private void setTopRatedList() {
        ...
        try {
            ...
            dialog = ProgressDialog.show(PopularMovies.this, "",
                                ...
                                mHandler.post(new Runnable() {
                                    ...
                                    public void run() {
                                        ...
                                        if (dialog != null && dialog.isShowing())
                                            dialog.dismiss();
                                        loadingMore = false;
                                        mainListAdapter = new NewRelAdapter(PopularMovies.this,topRatedList);
                                        int fvcount = mainList.getFooterViewsCount();
                                        for (int f = 0; f < fvcount; f++) {
                                            mainList.removeFooterView(footer);
                                        }
                                    ...
                                    public void run() {
                                        ...
                                        mainList.setOnItemClickListener(new OnItemClickListener() {
                                            ...
                                            public void onItemClick(AdapterView<?> parent, View view, int position,
                                                ...
                                                {
                                                    Intent i = new Intent(PopularMovies.this,SecondActivity.class);
    ...
    Runnable getDataOnListEnd = new Runnable() {
        ...
        public void run() {
            ...
            try {
                ...
                final List<TopRatedDAta> alist = data.getAlbumList(pageNo,"popular");
